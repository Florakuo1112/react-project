        ...
        <section >
            <div className="container" >
                <div  className=" p-md-5 d-md-flex justify-content-center align-items-center d-none ">
                    ...
                    <img src='public/catWithCase.png' style={{'maxWidth':'50%'}} className="img-fluid  d-block ps-5" alt="indexPhoto" />
                </div>

                <div  className=" p-5 d-md-none">
                    <img src='public/catWithCase.png' style={{'maxWidth':'100%'}} className="img-fluid  d-block " alt="indexPhoto" />
        ...
        <section>
            <div className="container p-5 d-none d-md-block ">
                ...
                <Swiper
                    ...
                    className="mySwiper">
                        <SwiperSlide>
                            <OurTeamComponent link="public/boss.png" title="店長 Angela" introduction="我是店長Angela，今年28歲。有四狗一貓，夢想是經營一間寵物旅館並將對動物的爱心注入到每一天的工作"></OurTeamComponent>
                        </SwiperSlide>
                        <SwiperSlide>
                            <OurTeamComponent link="public/美容師.png" title="美容師 佩佩" introduction="擁有國家認證的寵物美容丙級證照，喜歡和毛孩相處幫他們打扮的漂漂亮亮"></OurTeamComponent>
                        </SwiperSlide>
                        <SwiperSlide>
                            <OurTeamComponent link="public/保母.png" title="保母 Emma" introduction="我是毛孩的幼稚園老師，不僅對毛孩有耐心及愛心，更提供毛孩基礎社會化訓練"></OurTeamComponent>
                        </SwiperSlide>
                        <SwiperSlide>
                            <OurTeamComponent link="public/助理.png" title="助理 Nina" introduction="我付責接待爸爸媽媽與安排毛孩的房間與接送，雖然是小助理但是肩負大任。"></OurTeamComponent>
                        </SwiperSlide>
                </Swiper>
            </div>
        </section>
            ...
            <div className="container p-5 ">
                ...
                <div className="row">
                    <div className="col-12 col-md-4 d-flex align-items-center">
                        <img src='public/calendarPhoto.png' alt="calendarPhoto" style={{'maxWidth':'90%'}}/>
                    </div>
            ...
            <div className="container p-5 ">
                ...
                <div className="row  flex-column-reverse flex-md-row">
                    ...
                    <div className="col-md-4 d-flex align-items-center">
                        <img src='public/location.png' alt="location" style={{'maxWidth':'100%'}}/>
                    </div>
                </div>
            </div>
        </section>
